...
public class FeaturesGraphModelEContentAdapter extends EContentAdapter implements CincoEContentAdapter {
  @Override
  public void notifyChanged(final Notification notification) {
    super.notifyChanged(notification);
    final Object o = notification.getNotifier();
    final Object feature = notification.getFeature();
    if ((o instanceof InternalFeaturesGraphModel)) {
      if ((Objects.equal(((InternalFeaturesGraphModel)o).eContainer(), null) && (!(o instanceof InternalGraphModel)))) {
        return;
      }
