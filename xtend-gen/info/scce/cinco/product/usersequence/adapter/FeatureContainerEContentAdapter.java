...
import info.scce.cinco.product.usersequence.usersequence.internal.InternalFeatureContainer;
...
public class FeatureContainerEContentAdapter extends EContentAdapter implements CincoEContentAdapter {
  @Override
  public void notifyChanged(final Notification notification) {
    super.notifyChanged(notification);
    final Object o = notification.getNotifier();
    final Object feature = notification.getFeature();
    if ((o instanceof InternalFeatureContainer)) {
      if ((Objects.equal(((InternalFeatureContainer)o).eContainer(), null) && (!(o instanceof InternalGraphModel)))) {
        return;
      }
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          _matched=true;
          ModelElement _element = ((InternalFeatureContainer)o).getElement();
