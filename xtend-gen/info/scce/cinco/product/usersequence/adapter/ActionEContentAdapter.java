...
import info.scce.cinco.product.usersequence.usersequence.internal.InternalAction;
...
public class ActionEContentAdapter extends EContentAdapter implements CincoEContentAdapter {
  @Override
  public void notifyChanged(final Notification notification) {
    ...
    if ((o instanceof InternalAction)) {
      if ((Objects.equal(((InternalAction)o).eContainer(), null) && (!(o instanceof InternalGraphModel)))) {
        return;
      }
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          _matched=true;
          ModelElement _element = ((InternalAction)o).getElement();
