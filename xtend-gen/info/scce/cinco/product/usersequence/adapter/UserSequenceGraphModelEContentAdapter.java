...
public class UserSequenceGraphModelEContentAdapter extends EContentAdapter implements CincoEContentAdapter {
  @Override
  public void notifyChanged(final Notification notification) {
    super.notifyChanged(notification);
    final Object o = notification.getNotifier();
    final Object feature = notification.getFeature();
    if ((o instanceof InternalUserSequenceGraphModel)) {
      if ((Objects.equal(((InternalUserSequenceGraphModel)o).eContainer(), null) && (!(o instanceof InternalGraphModel)))) {
        return;
      }
