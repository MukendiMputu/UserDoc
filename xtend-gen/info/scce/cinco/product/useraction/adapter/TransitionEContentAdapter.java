package info.scce.cinco.product.useraction.adapter;
...
import info.scce.cinco.product.useraction.useraction.internal.InternalPackage;
import info.scce.cinco.product.useraction.useraction.internal.InternalTransition;
...
public class TransitionEContentAdapter extends EContentAdapter implements CincoEContentAdapter {
  @Override
  public void notifyChanged(final Notification notification) {
    super.notifyChanged(notification);
    final Object o = notification.getNotifier();
    final Object feature = notification.getFeature();
    if ((o instanceof InternalTransition)) {
      if ((Objects.equal(((InternalTransition)o).eContainer(), null) && (!(o instanceof InternalGraphModel)))) {
        return;
      }
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          _matched=true;
          ModelElement _element = ((InternalTransition)o).getElement();
