...
import info.scce.cinco.product.useraction.useraction.internal.InternalAttributes;
...
public class AttributesEContentAdapter extends EContentAdapter {
  @Extension
  ...
  public void notifyChanged(final Notification notification) {
    ...
    if ((o instanceof InternalAttributes)) {
      EObject _eContainer = ((InternalAttributes)o).eContainer();
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          _matched=true;
          Type _element = ((InternalAttributes)o).getElement();
