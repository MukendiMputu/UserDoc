...
import info.scce.cinco.product.useraction.useraction.internal.InternalUserActionGraphModel;
...
public class UserActionGraphModelEContentAdapter extends EContentAdapter implements CincoEContentAdapter {
  @Override
  public void notifyChanged(final Notification notification) {
    super.notifyChanged(notification);
    final Object o = notification.getNotifier();
    final Object feature = notification.getFeature();
    if ((o instanceof InternalUserActionGraphModel)) {
      if ((Objects.equal(((InternalUserActionGraphModel)o).eContainer(), null) && (!(o instanceof InternalGraphModel)))) {
        return;
      }
