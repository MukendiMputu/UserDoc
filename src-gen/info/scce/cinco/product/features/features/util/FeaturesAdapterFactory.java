...
public class FeaturesAdapterFactory extends AdapterFactoryImpl {
	...
	protected FeaturesSwitch<Adapter> modelSwitch =
		new FeaturesSwitch<Adapter>() {
			...
			@Override
			public Adapter caseDocNode(DocNode object) {
				return createDocNodeAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseFeaturesGraphModel(FeaturesGraphModel object) {
				return createFeaturesGraphModelAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseGraphmodel_Edge(graphmodel.Edge object) {
				return createGraphmodel_EdgeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link info.scce.cinco.product.features.features.StartNode <em>Start Node</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link info.scce.cinco.product.features.features.EndNode <em>End Node</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link info.scce.cinco.product.features.features.FeatureContainer <em>Feature Container</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link info.scce.cinco.product.features.features.DocNode <em>Doc Node</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDocNodeAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link info.scce.cinco.product.features.features.Edge <em>Edge</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link info.scce.cinco.product.features.features.LabeledEdge <em>Labeled Edge</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link info.scce.cinco.product.features.features.FeaturesGraphModel <em>Graph Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFeaturesGraphModelAdapter() {
		return null;
	}
	 ...
	 * @generated
	 */
	public Adapter createGraphmodel_EdgeAdapter() {
		return null;
	}
