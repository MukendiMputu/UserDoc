/**
 */
package info.scce.cinco.product.features.features.util;
...
public class FeaturesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FeaturesPackage.START_NODE: {
				StartNode startNode = (StartNode)theEObject;
				T result = caseStartNode(startNode);
				if (result == null) result = caseNode(startNode);
				if (result == null) result = caseModelElement(startNode);
				if (result == null) result = caseIdentifiableElement(startNode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FeaturesPackage.END_NODE: {
				EndNode endNode = (EndNode)theEObject;
				T result = caseEndNode(endNode);
				if (result == null) result = caseNode(endNode);
				if (result == null) result = caseModelElement(endNode);
				if (result == null) result = caseIdentifiableElement(endNode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FeaturesPackage.FEATURE_CONTAINER: {
				FeatureContainer featureContainer = (FeatureContainer)theEObject;
				T result = caseFeatureContainer(featureContainer);
				if (result == null) result = caseContainer(featureContainer);
				if (result == null) result = caseModelElementContainer(featureContainer);
				if (result == null) result = caseNode(featureContainer);
				if (result == null) result = caseModelElement(featureContainer);
				if (result == null) result = caseIdentifiableElement(featureContainer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FeaturesPackage.DOC_NODE: {
				DocNode docNode = (DocNode)theEObject;
				T result = caseDocNode(docNode);
				if (result == null) result = caseNode(docNode);
				if (result == null) result = caseModelElement(docNode);
				if (result == null) result = caseIdentifiableElement(docNode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FeaturesPackage.EDGE: {
				Edge edge = (Edge)theEObject;
				T result = caseEdge(edge);
				if (result == null) result = caseGraphmodel_Edge(edge);
				if (result == null) result = caseModelElement(edge);
				if (result == null) result = caseIdentifiableElement(edge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FeaturesPackage.LABELED_EDGE: {
				LabeledEdge labeledEdge = (LabeledEdge)theEObject;
				T result = caseLabeledEdge(labeledEdge);
				if (result == null) result = caseGraphmodel_Edge(labeledEdge);
				if (result == null) result = caseModelElement(labeledEdge);
				if (result == null) result = caseIdentifiableElement(labeledEdge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FeaturesPackage.FEATURES_GRAPH_MODEL: {
				FeaturesGraphModel featuresGraphModel = (FeaturesGraphModel)theEObject;
				T result = caseFeaturesGraphModel(featuresGraphModel);
				if (result == null) result = caseGraphModel(featuresGraphModel);
				if (result == null) result = caseModelElementContainer(featuresGraphModel);
				if (result == null) result = caseIdentifiableElement(featuresGraphModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseDocNode(DocNode object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseFeaturesGraphModel(FeaturesGraphModel object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseGraphmodel_Edge(graphmodel.Edge object) {
		return null;
	}
