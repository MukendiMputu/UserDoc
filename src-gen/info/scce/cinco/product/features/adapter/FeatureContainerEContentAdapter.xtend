...
class FeatureContainerEContentAdapter extends org.eclipse.emf.ecore.util.EContentAdapter implements de.jabc.cinco.meta.runtime.contentadapter.CincoEContentAdapter{
	...
	override notifyChanged(org.eclipse.emf.common.notify.Notification notification) {
		...
		if (o instanceof info.scce.cinco.product.features.features.internal.InternalFeatureContainer) {
