 ...
 * @generated
 */
public class LabeledTransitionImpl extends EdgeImpl implements LabeledTransition {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return UsersequencePackage.eINSTANCE.getLabeledTransition();
	}
	...
	public InternalLabeledTransition getInternalLabeledTransition() {
		return (info.scce.cinco.product.usersequence.usersequence.internal.InternalLabeledTransition) getInternalElement();
	}
	 ...
	 */
	@Override
	public boolean isExactlyLabeledTransition() {
		return true;
	}
	 ...
	 */
	@Override
	public LabeledTransitionView getLabeledTransitionView() {
		LabeledTransitionView labeledTransitionView = info.scce.cinco.product.usersequence.usersequence.views.ViewsFactory.eINSTANCE.createLabeledTransitionView();
		labeledTransitionView.setInternalLabeledTransition((info.scce.cinco.product.usersequence.usersequence.internal.InternalLabeledTransition)getInternalElement());
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == IdentifiableElement.class) {
			switch (baseOperationID) {
				case GraphmodelPackage.IDENTIFIABLE_ELEMENT___PRE_SAVE: return UsersequencePackage.LABELED_TRANSITION___PRE_SAVE;
				case GraphmodelPackage.IDENTIFIABLE_ELEMENT___POST_SAVE: return UsersequencePackage.LABELED_TRANSITION___POST_SAVE;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == ModelElement.class) {
			switch (baseOperationID) {
				case GraphmodelPackage.MODEL_ELEMENT___GET_ROOT_ELEMENT: return UsersequencePackage.LABELED_TRANSITION___GET_ROOT_ELEMENT;
				case GraphmodelPackage.MODEL_ELEMENT___PRE_SAVE: return UsersequencePackage.LABELED_TRANSITION___PRE_SAVE;
				case GraphmodelPackage.MODEL_ELEMENT___POST_SAVE: return UsersequencePackage.LABELED_TRANSITION___POST_SAVE;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == Edge.class) {
			switch (baseOperationID) {
				case GraphmodelPackage.EDGE___GET_SOURCE_ELEMENT: return UsersequencePackage.LABELED_TRANSITION___GET_SOURCE_ELEMENT;
				case GraphmodelPackage.EDGE___GET_TARGET_ELEMENT: return UsersequencePackage.LABELED_TRANSITION___GET_TARGET_ELEMENT;
				case GraphmodelPackage.EDGE___GET_POST_DELETE_FUNCTION: return UsersequencePackage.LABELED_TRANSITION___GET_POST_DELETE_FUNCTION;
				case GraphmodelPackage.EDGE___GET_POST_DELETE_EVENT: return UsersequencePackage.LABELED_TRANSITION___GET_POST_DELETE_EVENT;
				case GraphmodelPackage.EDGE___PRE_DELETE: return UsersequencePackage.LABELED_TRANSITION___PRE_DELETE;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case UsersequencePackage.LABELED_TRANSITION___GET_LABEL:
				return getLabel();
			case UsersequencePackage.LABELED_TRANSITION___SET_LABEL__STRING:
				setLabel((String)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___GET_INTERNAL_LABELED_TRANSITION:
				return getInternalLabeledTransition();
			case UsersequencePackage.LABELED_TRANSITION___IS_EXACTLY_LABELED_TRANSITION:
				return isExactlyLabeledTransition();
			case UsersequencePackage.LABELED_TRANSITION___PRE_DELETE:
				preDelete();
				return null;
			case UsersequencePackage.LABELED_TRANSITION___GET_POST_DELETE_FUNCTION:
				return getPostDeleteFunction();
			case UsersequencePackage.LABELED_TRANSITION___GET_POST_DELETE_EVENT:
				return getPostDeleteEvent();
			case UsersequencePackage.LABELED_TRANSITION___PRE_SAVE:
				preSave();
				return null;
			case UsersequencePackage.LABELED_TRANSITION___POST_SAVE:
				postSave();
				return null;
			case UsersequencePackage.LABELED_TRANSITION___GET_ROOT_ELEMENT:
				return getRootElement();
			case UsersequencePackage.LABELED_TRANSITION___GET_SOURCE_ELEMENT:
				return getSourceElement();
			case UsersequencePackage.LABELED_TRANSITION___GET_TARGET_ELEMENT:
				return getTargetElement();
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_SOURCE__START:
				return canReconnectSource((Start)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_SOURCE__START:
				reconnectSource((Start)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_SOURCE__SUBSEQUENCE:
				return canReconnectSource((SubSequence)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_SOURCE__SUBSEQUENCE:
				reconnectSource((SubSequence)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_SOURCE__INPUT:
				return canReconnectSource((Input)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_SOURCE__INPUT:
				reconnectSource((Input)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_SOURCE__TEXTAREA:
				return canReconnectSource((Textarea)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_SOURCE__TEXTAREA:
				reconnectSource((Textarea)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_SOURCE__BUTTON:
				return canReconnectSource((Button)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_SOURCE__BUTTON:
				reconnectSource((Button)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_SOURCE__SELECTBOX:
				return canReconnectSource((SelectBox)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_SOURCE__SELECTBOX:
				reconnectSource((SelectBox)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_SOURCE__SELECTBOXOPTION:
				return canReconnectSource((SelectBoxOption)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_SOURCE__SELECTBOXOPTION:
				reconnectSource((SelectBoxOption)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_SOURCE__TABLE:
				return canReconnectSource((Table)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_SOURCE__TABLE:
				reconnectSource((Table)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_SOURCE__TABLEHEAD:
				return canReconnectSource((TableHead)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_SOURCE__TABLEHEAD:
				reconnectSource((TableHead)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_SOURCE__TH:
				return canReconnectSource((Th)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_SOURCE__TH:
				reconnectSource((Th)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_SOURCE__TABLEROW:
				return canReconnectSource((TableRow)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_SOURCE__TABLEROW:
				reconnectSource((TableRow)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_SOURCE__TABLEBODY:
				return canReconnectSource((TableBody)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_SOURCE__TABLEBODY:
				reconnectSource((TableBody)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_SOURCE__TABLEDATA:
				return canReconnectSource((TableData)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_SOURCE__TABLEDATA:
				reconnectSource((TableData)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_SOURCE__SECTION:
				return canReconnectSource((Section)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_SOURCE__SECTION:
				reconnectSource((Section)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__P:
				return canReconnectTarget((P)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__P:
				reconnectTarget((P)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__TEXTAREA:
				return canReconnectTarget((Textarea)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__TEXTAREA:
				reconnectTarget((Textarea)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__SPAN:
				return canReconnectTarget((Span)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__SPAN:
				reconnectTarget((Span)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__TABLEBODY:
				return canReconnectTarget((TableBody)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__TABLEBODY:
				reconnectTarget((TableBody)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__SCREENSHOT:
				return canReconnectTarget((Screenshot)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__SCREENSHOT:
				reconnectTarget((Screenshot)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__FORM:
				return canReconnectTarget((Form)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__FORM:
				reconnectTarget((Form)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__NAVIGATION:
				return canReconnectTarget((Navigation)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__NAVIGATION:
				reconnectTarget((Navigation)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__SUBSEQUENCE:
				return canReconnectTarget((SubSequence)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__SUBSEQUENCE:
				reconnectTarget((SubSequence)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__STOP:
				return canReconnectTarget((Stop)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__STOP:
				reconnectTarget((Stop)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__TABLE:
				return canReconnectTarget((Table)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__TABLE:
				reconnectTarget((Table)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__LABEL:
				return canReconnectTarget((Label)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__LABEL:
				reconnectTarget((Label)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__TABLEROW:
				return canReconnectTarget((TableRow)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__TABLEROW:
				reconnectTarget((TableRow)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__SELECTBOX:
				return canReconnectTarget((SelectBox)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__SELECTBOX:
				reconnectTarget((SelectBox)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__TH:
				return canReconnectTarget((Th)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__TH:
				reconnectTarget((Th)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__SELECTBOXOPTION:
				return canReconnectTarget((SelectBoxOption)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__SELECTBOXOPTION:
				reconnectTarget((SelectBoxOption)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__INPUT:
				return canReconnectTarget((Input)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__INPUT:
				reconnectTarget((Input)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__TABLEDATA:
				return canReconnectTarget((TableData)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__TABLEDATA:
				reconnectTarget((TableData)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__WEBELEMENT:
				return canReconnectTarget((WebElement)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__WEBELEMENT:
				reconnectTarget((WebElement)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__DIV:
				return canReconnectTarget((Div)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__DIV:
				reconnectTarget((Div)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__BUTTON:
				return canReconnectTarget((Button)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__BUTTON:
				reconnectTarget((Button)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__SECTIONNODE:
				return canReconnectTarget((SectionNode)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__SECTIONNODE:
				reconnectTarget((SectionNode)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__H:
				return canReconnectTarget((H)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__H:
				reconnectTarget((H)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__TABLEHEAD:
				return canReconnectTarget((TableHead)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__TABLEHEAD:
				reconnectTarget((TableHead)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___CAN_RECONNECT_TARGET__SECTION:
				return canReconnectTarget((Section)arguments.get(0));
			case UsersequencePackage.LABELED_TRANSITION___RECONNECT_TARGET__SECTION:
				reconnectTarget((Section)arguments.get(0));
				return null;
			case UsersequencePackage.LABELED_TRANSITION___GET_LABELED_TRANSITION_VIEW:
				return getLabeledTransitionView();
		}
