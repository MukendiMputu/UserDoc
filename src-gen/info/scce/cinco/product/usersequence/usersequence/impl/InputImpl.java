 ...
 * @generated
 */
public class InputImpl extends WebElementImpl implements Input {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return UsersequencePackage.eINSTANCE.getInput();
	}
	...
	public InternalInput getInternalInput() {
		return (info.scce.cinco.product.usersequence.usersequence.internal.InternalInput) getInternalElement();
	}
	...
	public boolean canMoveTo(final UserSequenceGraphModel userSequenceGraphModel, final int x, final int y) {
		return userSequenceGraphModel.canContain(info.scce.cinco.product.usersequence.usersequence.Input.class);
	}
	...
	public InputView getInputView() {
		InputView inputView = info.scce.cinco.product.usersequence.usersequence.views.ViewsFactory.eINSTANCE.createInputView();
		inputView.setInternalInput((info.scce.cinco.product.usersequence.usersequence.internal.InternalInput)getInternalElement());
		return inputView;
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == IdentifiableElement.class) {
			switch (baseOperationID) {
				case GraphmodelPackage.IDENTIFIABLE_ELEMENT___PRE_SAVE: return UsersequencePackage.INPUT___PRE_SAVE;
				case GraphmodelPackage.IDENTIFIABLE_ELEMENT___POST_SAVE: return UsersequencePackage.INPUT___POST_SAVE;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == ModelElement.class) {
			switch (baseOperationID) {
				case GraphmodelPackage.MODEL_ELEMENT___GET_CONTAINER: return UsersequencePackage.INPUT___GET_CONTAINER;
				case GraphmodelPackage.MODEL_ELEMENT___GET_ROOT_ELEMENT: return UsersequencePackage.INPUT___GET_ROOT_ELEMENT;
				case GraphmodelPackage.MODEL_ELEMENT___PRE_SAVE: return UsersequencePackage.INPUT___PRE_SAVE;
				case GraphmodelPackage.MODEL_ELEMENT___POST_SAVE: return UsersequencePackage.INPUT___POST_SAVE;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == Node.class) {
			switch (baseOperationID) {
				case GraphmodelPackage.NODE___GET_SUCCESSORS: return UsersequencePackage.INPUT___GET_SUCCESSORS;
				case GraphmodelPackage.NODE___GET_PREDECESSORS: return UsersequencePackage.INPUT___GET_PREDECESSORS;
				case GraphmodelPackage.NODE___PRE_MOVE__MODELELEMENTCONTAINER_INT_INT: return UsersequencePackage.INPUT___PRE_MOVE__MODELELEMENTCONTAINER_INT_INT;
				case GraphmodelPackage.NODE___POST_MOVE__MODELELEMENTCONTAINER_MODELELEMENTCONTAINER_INT_INT_INT_INT: return UsersequencePackage.INPUT___POST_MOVE__MODELELEMENTCONTAINER_MODELELEMENTCONTAINER_INT_INT_INT_INT;
				case GraphmodelPackage.NODE___GET_POST_DELETE_FUNCTION: return UsersequencePackage.INPUT___GET_POST_DELETE_FUNCTION;
				case GraphmodelPackage.NODE___GET_POST_DELETE_EVENT: return UsersequencePackage.INPUT___GET_POST_DELETE_EVENT;
				case GraphmodelPackage.NODE___PRE_DELETE: return UsersequencePackage.INPUT___PRE_DELETE;
				case GraphmodelPackage.NODE___PRE_RESIZE__INT_INT_INT_INT_DIRECTION: return UsersequencePackage.INPUT___PRE_RESIZE__INT_INT_INT_INT_DIRECTION;
				case GraphmodelPackage.NODE___POST_RESIZE__INT_INT_INT_INT_DIRECTION: return UsersequencePackage.INPUT___POST_RESIZE__INT_INT_INT_INT_DIRECTION;
				case GraphmodelPackage.NODE___SMOVE_TO__MODELELEMENTCONTAINER_INT_INT: return UsersequencePackage.INPUT___SMOVE_TO__MODELELEMENTCONTAINER_INT_INT;
				case GraphmodelPackage.NODE___GET_INCOMING: return UsersequencePackage.INPUT___GET_INCOMING;
				case GraphmodelPackage.NODE___GET_OUTGOING: return UsersequencePackage.INPUT___GET_OUTGOING;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == WebElement.class) {
			switch (baseOperationID) {
				case UsersequencePackage.WEB_ELEMENT___PRE_DELETE: return UsersequencePackage.INPUT___PRE_DELETE;
				case UsersequencePackage.WEB_ELEMENT___GET_POST_DELETE_FUNCTION: return UsersequencePackage.INPUT___GET_POST_DELETE_FUNCTION;
				case UsersequencePackage.WEB_ELEMENT___GET_POST_DELETE_EVENT: return UsersequencePackage.INPUT___GET_POST_DELETE_EVENT;
				case UsersequencePackage.WEB_ELEMENT___PRE_SAVE: return UsersequencePackage.INPUT___PRE_SAVE;
				case UsersequencePackage.WEB_ELEMENT___POST_SAVE: return UsersequencePackage.INPUT___POST_SAVE;
				case UsersequencePackage.WEB_ELEMENT___GET_ROOT_ELEMENT: return UsersequencePackage.INPUT___GET_ROOT_ELEMENT;
				case UsersequencePackage.WEB_ELEMENT___GET_OUTGOING: return UsersequencePackage.INPUT___GET_OUTGOING;
				case UsersequencePackage.WEB_ELEMENT___GET_SUCCESSORS: return UsersequencePackage.INPUT___GET_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_INCOMING: return UsersequencePackage.INPUT___GET_INCOMING;
				case UsersequencePackage.WEB_ELEMENT___GET_PREDECESSORS: return UsersequencePackage.INPUT___GET_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___SMOVE_TO__MODELELEMENTCONTAINER_INT_INT: return UsersequencePackage.INPUT___SMOVE_TO__MODELELEMENTCONTAINER_INT_INT;
				case UsersequencePackage.WEB_ELEMENT___PRE_MOVE__MODELELEMENTCONTAINER_INT_INT: return UsersequencePackage.INPUT___PRE_MOVE__MODELELEMENTCONTAINER_INT_INT;
				case UsersequencePackage.WEB_ELEMENT___POST_MOVE__MODELELEMENTCONTAINER_MODELELEMENTCONTAINER_INT_INT_INT_INT: return UsersequencePackage.INPUT___POST_MOVE__MODELELEMENTCONTAINER_MODELELEMENTCONTAINER_INT_INT_INT_INT;
				case UsersequencePackage.WEB_ELEMENT___PRE_RESIZE__INT_INT_INT_INT_DIRECTION: return UsersequencePackage.INPUT___PRE_RESIZE__INT_INT_INT_INT_DIRECTION;
				case UsersequencePackage.WEB_ELEMENT___POST_RESIZE__INT_INT_INT_INT_DIRECTION: return UsersequencePackage.INPUT___POST_RESIZE__INT_INT_INT_INT_DIRECTION;
				case UsersequencePackage.WEB_ELEMENT___GET_OUTGOING_LABELED_TRANSITIONS: return UsersequencePackage.INPUT___GET_OUTGOING_LABELED_TRANSITIONS;
				case UsersequencePackage.WEB_ELEMENT___GET_OUTGOING_TRANSITIONS: return UsersequencePackage.INPUT___GET_OUTGOING_TRANSITIONS;
				case UsersequencePackage.WEB_ELEMENT___GET_INCOMING_ANCHORS: return UsersequencePackage.INPUT___GET_INCOMING_ANCHORS;
				case UsersequencePackage.WEB_ELEMENT___GET_INCOMING_LABELED_TRANSITIONS: return UsersequencePackage.INPUT___GET_INCOMING_LABELED_TRANSITIONS;
				case UsersequencePackage.WEB_ELEMENT___GET_INCOMING_TRANSITIONS: return UsersequencePackage.INPUT___GET_INCOMING_TRANSITIONS;
				case UsersequencePackage.WEB_ELEMENT___GET_START_PREDECESSORS: return UsersequencePackage.INPUT___GET_START_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_SUB_SEQUENCE_PREDECESSORS: return UsersequencePackage.INPUT___GET_SUB_SEQUENCE_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_SCREENSHOT_PREDECESSORS: return UsersequencePackage.INPUT___GET_SCREENSHOT_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_SECTION_NODE_PREDECESSORS: return UsersequencePackage.INPUT___GET_SECTION_NODE_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_NAVIGATION_PREDECESSORS: return UsersequencePackage.INPUT___GET_NAVIGATION_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_WEB_ELEMENT_PREDECESSORS: return UsersequencePackage.INPUT___GET_WEB_ELEMENT_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_DIV_PREDECESSORS: return UsersequencePackage.INPUT___GET_DIV_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_HPREDECESSORS: return UsersequencePackage.INPUT___GET_HPREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_PPREDECESSORS: return UsersequencePackage.INPUT___GET_PPREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_SPAN_PREDECESSORS: return UsersequencePackage.INPUT___GET_SPAN_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_LABEL_PREDECESSORS: return UsersequencePackage.INPUT___GET_LABEL_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_FORM_PREDECESSORS: return UsersequencePackage.INPUT___GET_FORM_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_INPUT_PREDECESSORS: return UsersequencePackage.INPUT___GET_INPUT_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_TEXTAREA_PREDECESSORS: return UsersequencePackage.INPUT___GET_TEXTAREA_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_BUTTON_PREDECESSORS: return UsersequencePackage.INPUT___GET_BUTTON_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_SELECT_BOX_PREDECESSORS: return UsersequencePackage.INPUT___GET_SELECT_BOX_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_SELECT_BOX_OPTION_PREDECESSORS: return UsersequencePackage.INPUT___GET_SELECT_BOX_OPTION_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_TABLE_PREDECESSORS: return UsersequencePackage.INPUT___GET_TABLE_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_TABLE_HEAD_PREDECESSORS: return UsersequencePackage.INPUT___GET_TABLE_HEAD_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_TH_PREDECESSORS: return UsersequencePackage.INPUT___GET_TH_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_TABLE_ROW_PREDECESSORS: return UsersequencePackage.INPUT___GET_TABLE_ROW_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_TABLE_BODY_PREDECESSORS: return UsersequencePackage.INPUT___GET_TABLE_BODY_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_TABLE_DATA_PREDECESSORS: return UsersequencePackage.INPUT___GET_TABLE_DATA_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_SECTION_PREDECESSORS: return UsersequencePackage.INPUT___GET_SECTION_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_COMMENT_PREDECESSORS: return UsersequencePackage.INPUT___GET_COMMENT_PREDECESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_STOP_SUCCESSORS: return UsersequencePackage.INPUT___GET_STOP_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_SUB_SEQUENCE_SUCCESSORS: return UsersequencePackage.INPUT___GET_SUB_SEQUENCE_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_SCREENSHOT_SUCCESSORS: return UsersequencePackage.INPUT___GET_SCREENSHOT_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_SECTION_NODE_SUCCESSORS: return UsersequencePackage.INPUT___GET_SECTION_NODE_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_NAVIGATION_SUCCESSORS: return UsersequencePackage.INPUT___GET_NAVIGATION_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_WEB_ELEMENT_SUCCESSORS: return UsersequencePackage.INPUT___GET_WEB_ELEMENT_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_DIV_SUCCESSORS: return UsersequencePackage.INPUT___GET_DIV_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_HSUCCESSORS: return UsersequencePackage.INPUT___GET_HSUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_PSUCCESSORS: return UsersequencePackage.INPUT___GET_PSUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_SPAN_SUCCESSORS: return UsersequencePackage.INPUT___GET_SPAN_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_LABEL_SUCCESSORS: return UsersequencePackage.INPUT___GET_LABEL_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_FORM_SUCCESSORS: return UsersequencePackage.INPUT___GET_FORM_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_INPUT_SUCCESSORS: return UsersequencePackage.INPUT___GET_INPUT_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_TEXTAREA_SUCCESSORS: return UsersequencePackage.INPUT___GET_TEXTAREA_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_BUTTON_SUCCESSORS: return UsersequencePackage.INPUT___GET_BUTTON_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_SELECT_BOX_SUCCESSORS: return UsersequencePackage.INPUT___GET_SELECT_BOX_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_SELECT_BOX_OPTION_SUCCESSORS: return UsersequencePackage.INPUT___GET_SELECT_BOX_OPTION_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_TABLE_SUCCESSORS: return UsersequencePackage.INPUT___GET_TABLE_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_TABLE_HEAD_SUCCESSORS: return UsersequencePackage.INPUT___GET_TABLE_HEAD_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_TH_SUCCESSORS: return UsersequencePackage.INPUT___GET_TH_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_TABLE_ROW_SUCCESSORS: return UsersequencePackage.INPUT___GET_TABLE_ROW_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_TABLE_BODY_SUCCESSORS: return UsersequencePackage.INPUT___GET_TABLE_BODY_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_TABLE_DATA_SUCCESSORS: return UsersequencePackage.INPUT___GET_TABLE_DATA_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___GET_SECTION_SUCCESSORS: return UsersequencePackage.INPUT___GET_SECTION_SUCCESSORS;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__P: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__P;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__P: return UsersequencePackage.INPUT___NEW_TRANSITION__P;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__P_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__P_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__TEXTAREA: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__TEXTAREA;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__TEXTAREA: return UsersequencePackage.INPUT___NEW_TRANSITION__TEXTAREA;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__TEXTAREA_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__TEXTAREA_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__SPAN: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__SPAN;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__SPAN: return UsersequencePackage.INPUT___NEW_TRANSITION__SPAN;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__SPAN_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__SPAN_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__TABLEBODY: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__TABLEBODY;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__TABLEBODY: return UsersequencePackage.INPUT___NEW_TRANSITION__TABLEBODY;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__TABLEBODY_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__TABLEBODY_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__SCREENSHOT: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__SCREENSHOT;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__SCREENSHOT: return UsersequencePackage.INPUT___NEW_TRANSITION__SCREENSHOT;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__SCREENSHOT_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__SCREENSHOT_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__FORM: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__FORM;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__FORM: return UsersequencePackage.INPUT___NEW_TRANSITION__FORM;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__FORM_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__FORM_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__NAVIGATION: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__NAVIGATION;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__NAVIGATION: return UsersequencePackage.INPUT___NEW_TRANSITION__NAVIGATION;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__NAVIGATION_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__NAVIGATION_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__SUBSEQUENCE: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__SUBSEQUENCE;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__SUBSEQUENCE: return UsersequencePackage.INPUT___NEW_TRANSITION__SUBSEQUENCE;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__SUBSEQUENCE_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__SUBSEQUENCE_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__STOP: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__STOP;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__STOP: return UsersequencePackage.INPUT___NEW_TRANSITION__STOP;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__STOP_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__STOP_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__TABLE: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__TABLE;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__TABLE: return UsersequencePackage.INPUT___NEW_TRANSITION__TABLE;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__TABLE_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__TABLE_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__LABEL: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__LABEL;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__LABEL: return UsersequencePackage.INPUT___NEW_TRANSITION__LABEL;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__LABEL_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__LABEL_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__TABLEROW: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__TABLEROW;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__TABLEROW: return UsersequencePackage.INPUT___NEW_TRANSITION__TABLEROW;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__TABLEROW_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__TABLEROW_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__SELECTBOX: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__SELECTBOX;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__SELECTBOX: return UsersequencePackage.INPUT___NEW_TRANSITION__SELECTBOX;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__SELECTBOX_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__SELECTBOX_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__TH: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__TH;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__TH: return UsersequencePackage.INPUT___NEW_TRANSITION__TH;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__TH_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__TH_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__SELECTBOXOPTION: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__SELECTBOXOPTION;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__SELECTBOXOPTION: return UsersequencePackage.INPUT___NEW_TRANSITION__SELECTBOXOPTION;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__SELECTBOXOPTION_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__SELECTBOXOPTION_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__INPUT: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__INPUT;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__INPUT: return UsersequencePackage.INPUT___NEW_TRANSITION__INPUT;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__INPUT_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__INPUT_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__TABLEDATA: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__TABLEDATA;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__TABLEDATA: return UsersequencePackage.INPUT___NEW_TRANSITION__TABLEDATA;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__TABLEDATA_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__TABLEDATA_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__WEBELEMENT: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__WEBELEMENT;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__WEBELEMENT: return UsersequencePackage.INPUT___NEW_TRANSITION__WEBELEMENT;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__WEBELEMENT_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__WEBELEMENT_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__DIV: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__DIV;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__DIV: return UsersequencePackage.INPUT___NEW_TRANSITION__DIV;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__DIV_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__DIV_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__BUTTON: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__BUTTON;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__BUTTON: return UsersequencePackage.INPUT___NEW_TRANSITION__BUTTON;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__BUTTON_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__BUTTON_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__SECTIONNODE: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__SECTIONNODE;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__SECTIONNODE: return UsersequencePackage.INPUT___NEW_TRANSITION__SECTIONNODE;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__SECTIONNODE_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__SECTIONNODE_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__H: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__H;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__H: return UsersequencePackage.INPUT___NEW_TRANSITION__H;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__H_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__H_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__TABLEHEAD: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__TABLEHEAD;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__TABLEHEAD: return UsersequencePackage.INPUT___NEW_TRANSITION__TABLEHEAD;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__TABLEHEAD_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__TABLEHEAD_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_NEW_TRANSITION__SECTION: return UsersequencePackage.INPUT___CAN_NEW_TRANSITION__SECTION;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__SECTION: return UsersequencePackage.INPUT___NEW_TRANSITION__SECTION;
				case UsersequencePackage.WEB_ELEMENT___NEW_TRANSITION__SECTION_STRING: return UsersequencePackage.INPUT___NEW_TRANSITION__SECTION_STRING;
				case UsersequencePackage.WEB_ELEMENT___CAN_MOVE_TO__USERSEQUENCEGRAPHMODEL_INT_INT: return UsersequencePackage.INPUT___CAN_MOVE_TO__USERSEQUENCEGRAPHMODEL_INT_INT;
				case UsersequencePackage.WEB_ELEMENT___MOVE_TO__USERSEQUENCEGRAPHMODEL_INT_INT: return UsersequencePackage.INPUT___MOVE_TO__USERSEQUENCEGRAPHMODEL_INT_INT;
				case UsersequencePackage.WEB_ELEMENT___SMOVE_TO__USERSEQUENCEGRAPHMODEL_INT_INT: return UsersequencePackage.INPUT___SMOVE_TO__USERSEQUENCEGRAPHMODEL_INT_INT;
				case UsersequencePackage.WEB_ELEMENT___GET_CONTAINER: return UsersequencePackage.INPUT___GET_CONTAINER;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case UsersequencePackage.INPUT___IS_HIGHLIGHTED:
				return isHighlighted();
			case UsersequencePackage.INPUT___SET_HIGHLIGHTED__BOOLEAN:
				setHighlighted((Boolean)arguments.get(0));
				return null;
			case UsersequencePackage.INPUT___GET_SELECTOR:
				return getSelector();
			case UsersequencePackage.INPUT___SET_SELECTOR__STRING:
				setSelector((String)arguments.get(0));
				return null;
			case UsersequencePackage.INPUT___GET_VALUE:
				return getValue();
			case UsersequencePackage.INPUT___SET_VALUE__STRING:
				setValue((String)arguments.get(0));
				return null;
			case UsersequencePackage.INPUT___GET_CONTENT:
				return getContent();
			case UsersequencePackage.INPUT___SET_CONTENT__STRING:
				setContent((String)arguments.get(0));
				return null;
			case UsersequencePackage.INPUT___GET_INTERNAL_INPUT:
				return getInternalInput();
			case UsersequencePackage.INPUT___IS_EXACTLY_INPUT:
				return isExactlyInput();
			case UsersequencePackage.INPUT___PRE_DELETE:
				preDelete();
				return null;
			case UsersequencePackage.INPUT___GET_POST_DELETE_FUNCTION:
				return getPostDeleteFunction();
			case UsersequencePackage.INPUT___GET_POST_DELETE_EVENT:
				return getPostDeleteEvent();
			case UsersequencePackage.INPUT___PRE_SAVE:
				preSave();
				return null;
			case UsersequencePackage.INPUT___POST_SAVE:
				postSave();
				return null;
			case UsersequencePackage.INPUT___GET_ROOT_ELEMENT:
				return getRootElement();
			case UsersequencePackage.INPUT___GET_OUTGOING:
				return getOutgoing();
			case UsersequencePackage.INPUT___GET_SUCCESSORS:
				return getSuccessors();
			case UsersequencePackage.INPUT___GET_INCOMING:
				return getIncoming();
			case UsersequencePackage.INPUT___GET_PREDECESSORS:
				return getPredecessors();
			case UsersequencePackage.INPUT___SMOVE_TO__MODELELEMENTCONTAINER_INT_INT:
				s_moveTo((ModelElementContainer)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
				return null;
			case UsersequencePackage.INPUT___PRE_MOVE__MODELELEMENTCONTAINER_INT_INT:
				preMove((ModelElementContainer)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
				return null;
			case UsersequencePackage.INPUT___POST_MOVE__MODELELEMENTCONTAINER_MODELELEMENTCONTAINER_INT_INT_INT_INT:
				postMove((ModelElementContainer)arguments.get(0), (ModelElementContainer)arguments.get(1), (Integer)arguments.get(2), (Integer)arguments.get(3), (Integer)arguments.get(4), (Integer)arguments.get(5));
				return null;
			case UsersequencePackage.INPUT___PRE_RESIZE__INT_INT_INT_INT_DIRECTION:
				preResize((Integer)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2), (Integer)arguments.get(3), (Direction)arguments.get(4));
				return null;
			case UsersequencePackage.INPUT___POST_RESIZE__INT_INT_INT_INT_DIRECTION:
				postResize((Integer)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2), (Integer)arguments.get(3), (Direction)arguments.get(4));
				return null;
			case UsersequencePackage.INPUT___GET_OUTGOING_LABELED_TRANSITIONS:
				return getOutgoingLabeledTransitions();
			case UsersequencePackage.INPUT___GET_OUTGOING_TRANSITIONS:
				return getOutgoingTransitions();
			case UsersequencePackage.INPUT___GET_INCOMING_ANCHORS:
				return getIncomingAnchors();
			case UsersequencePackage.INPUT___GET_INCOMING_LABELED_TRANSITIONS:
				return getIncomingLabeledTransitions();
			case UsersequencePackage.INPUT___GET_INCOMING_TRANSITIONS:
				return getIncomingTransitions();
			case UsersequencePackage.INPUT___GET_START_PREDECESSORS:
				return getStartPredecessors();
			case UsersequencePackage.INPUT___GET_SUB_SEQUENCE_PREDECESSORS:
				return getSubSequencePredecessors();
			case UsersequencePackage.INPUT___GET_SCREENSHOT_PREDECESSORS:
				return getScreenshotPredecessors();
			case UsersequencePackage.INPUT___GET_SECTION_NODE_PREDECESSORS:
				return getSectionNodePredecessors();
			case UsersequencePackage.INPUT___GET_NAVIGATION_PREDECESSORS:
				return getNavigationPredecessors();
			case UsersequencePackage.INPUT___GET_WEB_ELEMENT_PREDECESSORS:
				return getWebElementPredecessors();
			case UsersequencePackage.INPUT___GET_DIV_PREDECESSORS:
				return getDivPredecessors();
			case UsersequencePackage.INPUT___GET_HPREDECESSORS:
				return getHPredecessors();
			case UsersequencePackage.INPUT___GET_PPREDECESSORS:
				return getPPredecessors();
			case UsersequencePackage.INPUT___GET_SPAN_PREDECESSORS:
				return getSpanPredecessors();
			case UsersequencePackage.INPUT___GET_LABEL_PREDECESSORS:
				return getLabelPredecessors();
			case UsersequencePackage.INPUT___GET_FORM_PREDECESSORS:
				return getFormPredecessors();
			case UsersequencePackage.INPUT___GET_INPUT_PREDECESSORS:
				return getInputPredecessors();
			case UsersequencePackage.INPUT___GET_TEXTAREA_PREDECESSORS:
				return getTextareaPredecessors();
			case UsersequencePackage.INPUT___GET_BUTTON_PREDECESSORS:
				return getButtonPredecessors();
			case UsersequencePackage.INPUT___GET_SELECT_BOX_PREDECESSORS:
				return getSelectBoxPredecessors();
			case UsersequencePackage.INPUT___GET_SELECT_BOX_OPTION_PREDECESSORS:
				return getSelectBoxOptionPredecessors();
			case UsersequencePackage.INPUT___GET_TABLE_PREDECESSORS:
				return getTablePredecessors();
			case UsersequencePackage.INPUT___GET_TABLE_HEAD_PREDECESSORS:
				return getTableHeadPredecessors();
			case UsersequencePackage.INPUT___GET_TH_PREDECESSORS:
				return getThPredecessors();
			case UsersequencePackage.INPUT___GET_TABLE_ROW_PREDECESSORS:
				return getTableRowPredecessors();
			case UsersequencePackage.INPUT___GET_TABLE_BODY_PREDECESSORS:
				return getTableBodyPredecessors();
			case UsersequencePackage.INPUT___GET_TABLE_DATA_PREDECESSORS:
				return getTableDataPredecessors();
			case UsersequencePackage.INPUT___GET_SECTION_PREDECESSORS:
				return getSectionPredecessors();
			case UsersequencePackage.INPUT___GET_COMMENT_PREDECESSORS:
				return getCommentPredecessors();
			case UsersequencePackage.INPUT___GET_STOP_SUCCESSORS:
				return getStopSuccessors();
			case UsersequencePackage.INPUT___GET_SUB_SEQUENCE_SUCCESSORS:
				return getSubSequenceSuccessors();
			case UsersequencePackage.INPUT___GET_SCREENSHOT_SUCCESSORS:
				return getScreenshotSuccessors();
			case UsersequencePackage.INPUT___GET_SECTION_NODE_SUCCESSORS:
				return getSectionNodeSuccessors();
			case UsersequencePackage.INPUT___GET_NAVIGATION_SUCCESSORS:
				return getNavigationSuccessors();
			case UsersequencePackage.INPUT___GET_WEB_ELEMENT_SUCCESSORS:
				return getWebElementSuccessors();
			case UsersequencePackage.INPUT___GET_DIV_SUCCESSORS:
				return getDivSuccessors();
			case UsersequencePackage.INPUT___GET_HSUCCESSORS:
				return getHSuccessors();
			case UsersequencePackage.INPUT___GET_PSUCCESSORS:
				return getPSuccessors();
			case UsersequencePackage.INPUT___GET_SPAN_SUCCESSORS:
				return getSpanSuccessors();
			case UsersequencePackage.INPUT___GET_LABEL_SUCCESSORS:
				return getLabelSuccessors();
			case UsersequencePackage.INPUT___GET_FORM_SUCCESSORS:
				return getFormSuccessors();
			case UsersequencePackage.INPUT___GET_INPUT_SUCCESSORS:
				return getInputSuccessors();
			case UsersequencePackage.INPUT___GET_TEXTAREA_SUCCESSORS:
				return getTextareaSuccessors();
			case UsersequencePackage.INPUT___GET_BUTTON_SUCCESSORS:
				return getButtonSuccessors();
			case UsersequencePackage.INPUT___GET_SELECT_BOX_SUCCESSORS:
				return getSelectBoxSuccessors();
			case UsersequencePackage.INPUT___GET_SELECT_BOX_OPTION_SUCCESSORS:
				return getSelectBoxOptionSuccessors();
			case UsersequencePackage.INPUT___GET_TABLE_SUCCESSORS:
				return getTableSuccessors();
			case UsersequencePackage.INPUT___GET_TABLE_HEAD_SUCCESSORS:
				return getTableHeadSuccessors();
			case UsersequencePackage.INPUT___GET_TH_SUCCESSORS:
				return getThSuccessors();
			case UsersequencePackage.INPUT___GET_TABLE_ROW_SUCCESSORS:
				return getTableRowSuccessors();
			case UsersequencePackage.INPUT___GET_TABLE_BODY_SUCCESSORS:
				return getTableBodySuccessors();
			case UsersequencePackage.INPUT___GET_TABLE_DATA_SUCCESSORS:
				return getTableDataSuccessors();
			case UsersequencePackage.INPUT___GET_SECTION_SUCCESSORS:
				return getSectionSuccessors();
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__P:
				return canNewLabeledTransition((P)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__P:
				return newLabeledTransition((P)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__P_STRING:
				return newLabeledTransition((P)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__TEXTAREA:
				return canNewLabeledTransition((Textarea)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__TEXTAREA:
				return newLabeledTransition((Textarea)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__TEXTAREA_STRING:
				return newLabeledTransition((Textarea)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__SPAN:
				return canNewLabeledTransition((Span)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__SPAN:
				return newLabeledTransition((Span)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__SPAN_STRING:
				return newLabeledTransition((Span)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__TABLEBODY:
				return canNewLabeledTransition((TableBody)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__TABLEBODY:
				return newLabeledTransition((TableBody)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__TABLEBODY_STRING:
				return newLabeledTransition((TableBody)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__SCREENSHOT:
				return canNewLabeledTransition((Screenshot)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__SCREENSHOT:
				return newLabeledTransition((Screenshot)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__SCREENSHOT_STRING:
				return newLabeledTransition((Screenshot)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__FORM:
				return canNewLabeledTransition((Form)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__FORM:
				return newLabeledTransition((Form)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__FORM_STRING:
				return newLabeledTransition((Form)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__NAVIGATION:
				return canNewLabeledTransition((Navigation)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__NAVIGATION:
				return newLabeledTransition((Navigation)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__NAVIGATION_STRING:
				return newLabeledTransition((Navigation)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__SUBSEQUENCE:
				return canNewLabeledTransition((SubSequence)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__SUBSEQUENCE:
				return newLabeledTransition((SubSequence)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__SUBSEQUENCE_STRING:
				return newLabeledTransition((SubSequence)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__STOP:
				return canNewLabeledTransition((Stop)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__STOP:
				return newLabeledTransition((Stop)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__STOP_STRING:
				return newLabeledTransition((Stop)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__TABLE:
				return canNewLabeledTransition((Table)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__TABLE:
				return newLabeledTransition((Table)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__TABLE_STRING:
				return newLabeledTransition((Table)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__LABEL:
				return canNewLabeledTransition((Label)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__LABEL:
				return newLabeledTransition((Label)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__LABEL_STRING:
				return newLabeledTransition((Label)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__TABLEROW:
				return canNewLabeledTransition((TableRow)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__TABLEROW:
				return newLabeledTransition((TableRow)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__TABLEROW_STRING:
				return newLabeledTransition((TableRow)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__SELECTBOX:
				return canNewLabeledTransition((SelectBox)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__SELECTBOX:
				return newLabeledTransition((SelectBox)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__SELECTBOX_STRING:
				return newLabeledTransition((SelectBox)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__TH:
				return canNewLabeledTransition((Th)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__TH:
				return newLabeledTransition((Th)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__TH_STRING:
				return newLabeledTransition((Th)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__SELECTBOXOPTION:
				return canNewLabeledTransition((SelectBoxOption)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__SELECTBOXOPTION:
				return newLabeledTransition((SelectBoxOption)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__SELECTBOXOPTION_STRING:
				return newLabeledTransition((SelectBoxOption)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__INPUT:
				return canNewLabeledTransition((Input)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__INPUT:
				return newLabeledTransition((Input)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__INPUT_STRING:
				return newLabeledTransition((Input)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__TABLEDATA:
				return canNewLabeledTransition((TableData)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__TABLEDATA:
				return newLabeledTransition((TableData)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__TABLEDATA_STRING:
				return newLabeledTransition((TableData)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__WEBELEMENT:
				return canNewLabeledTransition((WebElement)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__WEBELEMENT:
				return newLabeledTransition((WebElement)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__WEBELEMENT_STRING:
				return newLabeledTransition((WebElement)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__DIV:
				return canNewLabeledTransition((Div)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__DIV:
				return newLabeledTransition((Div)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__DIV_STRING:
				return newLabeledTransition((Div)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__BUTTON:
				return canNewLabeledTransition((Button)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__BUTTON:
				return newLabeledTransition((Button)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__BUTTON_STRING:
				return newLabeledTransition((Button)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__SECTIONNODE:
				return canNewLabeledTransition((SectionNode)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__SECTIONNODE:
				return newLabeledTransition((SectionNode)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__SECTIONNODE_STRING:
				return newLabeledTransition((SectionNode)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__H:
				return canNewLabeledTransition((H)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__H:
				return newLabeledTransition((H)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__H_STRING:
				return newLabeledTransition((H)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__TABLEHEAD:
				return canNewLabeledTransition((TableHead)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__TABLEHEAD:
				return newLabeledTransition((TableHead)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__TABLEHEAD_STRING:
				return newLabeledTransition((TableHead)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_LABELED_TRANSITION__SECTION:
				return canNewLabeledTransition((Section)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__SECTION:
				return newLabeledTransition((Section)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_LABELED_TRANSITION__SECTION_STRING:
				return newLabeledTransition((Section)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__P:
				return canNewTransition((P)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__P:
				return newTransition((P)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__P_STRING:
				return newTransition((P)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__TEXTAREA:
				return canNewTransition((Textarea)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__TEXTAREA:
				return newTransition((Textarea)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__TEXTAREA_STRING:
				return newTransition((Textarea)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__SPAN:
				return canNewTransition((Span)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__SPAN:
				return newTransition((Span)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__SPAN_STRING:
				return newTransition((Span)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__TABLEBODY:
				return canNewTransition((TableBody)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__TABLEBODY:
				return newTransition((TableBody)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__TABLEBODY_STRING:
				return newTransition((TableBody)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__SCREENSHOT:
				return canNewTransition((Screenshot)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__SCREENSHOT:
				return newTransition((Screenshot)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__SCREENSHOT_STRING:
				return newTransition((Screenshot)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__FORM:
				return canNewTransition((Form)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__FORM:
				return newTransition((Form)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__FORM_STRING:
				return newTransition((Form)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__NAVIGATION:
				return canNewTransition((Navigation)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__NAVIGATION:
				return newTransition((Navigation)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__NAVIGATION_STRING:
				return newTransition((Navigation)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__SUBSEQUENCE:
				return canNewTransition((SubSequence)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__SUBSEQUENCE:
				return newTransition((SubSequence)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__SUBSEQUENCE_STRING:
				return newTransition((SubSequence)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__STOP:
				return canNewTransition((Stop)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__STOP:
				return newTransition((Stop)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__STOP_STRING:
				return newTransition((Stop)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__TABLE:
				return canNewTransition((Table)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__TABLE:
				return newTransition((Table)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__TABLE_STRING:
				return newTransition((Table)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__LABEL:
				return canNewTransition((Label)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__LABEL:
				return newTransition((Label)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__LABEL_STRING:
				return newTransition((Label)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__TABLEROW:
				return canNewTransition((TableRow)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__TABLEROW:
				return newTransition((TableRow)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__TABLEROW_STRING:
				return newTransition((TableRow)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__SELECTBOX:
				return canNewTransition((SelectBox)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__SELECTBOX:
				return newTransition((SelectBox)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__SELECTBOX_STRING:
				return newTransition((SelectBox)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__TH:
				return canNewTransition((Th)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__TH:
				return newTransition((Th)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__TH_STRING:
				return newTransition((Th)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__SELECTBOXOPTION:
				return canNewTransition((SelectBoxOption)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__SELECTBOXOPTION:
				return newTransition((SelectBoxOption)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__SELECTBOXOPTION_STRING:
				return newTransition((SelectBoxOption)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__INPUT:
				return canNewTransition((Input)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__INPUT:
				return newTransition((Input)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__INPUT_STRING:
				return newTransition((Input)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__TABLEDATA:
				return canNewTransition((TableData)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__TABLEDATA:
				return newTransition((TableData)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__TABLEDATA_STRING:
				return newTransition((TableData)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__WEBELEMENT:
				return canNewTransition((WebElement)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__WEBELEMENT:
				return newTransition((WebElement)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__WEBELEMENT_STRING:
				return newTransition((WebElement)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__DIV:
				return canNewTransition((Div)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__DIV:
				return newTransition((Div)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__DIV_STRING:
				return newTransition((Div)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__BUTTON:
				return canNewTransition((Button)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__BUTTON:
				return newTransition((Button)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__BUTTON_STRING:
				return newTransition((Button)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__SECTIONNODE:
				return canNewTransition((SectionNode)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__SECTIONNODE:
				return newTransition((SectionNode)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__SECTIONNODE_STRING:
				return newTransition((SectionNode)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__H:
				return canNewTransition((H)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__H:
				return newTransition((H)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__H_STRING:
				return newTransition((H)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__TABLEHEAD:
				return canNewTransition((TableHead)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__TABLEHEAD:
				return newTransition((TableHead)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__TABLEHEAD_STRING:
				return newTransition((TableHead)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_NEW_TRANSITION__SECTION:
				return canNewTransition((Section)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__SECTION:
				return newTransition((Section)arguments.get(0));
			case UsersequencePackage.INPUT___NEW_TRANSITION__SECTION_STRING:
				return newTransition((Section)arguments.get(0), (String)arguments.get(1));
			case UsersequencePackage.INPUT___CAN_MOVE_TO__USERSEQUENCEGRAPHMODEL_INT_INT:
				return canMoveTo((UserSequenceGraphModel)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
			case UsersequencePackage.INPUT___MOVE_TO__USERSEQUENCEGRAPHMODEL_INT_INT:
				moveTo((UserSequenceGraphModel)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
				return null;
			case UsersequencePackage.INPUT___SMOVE_TO__USERSEQUENCEGRAPHMODEL_INT_INT:
				s_moveTo((UserSequenceGraphModel)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
				return null;
			case UsersequencePackage.INPUT___GET_CONTAINER:
				return getContainer();
			case UsersequencePackage.INPUT___GET_INPUT_VIEW:
				return getInputView();
		}
