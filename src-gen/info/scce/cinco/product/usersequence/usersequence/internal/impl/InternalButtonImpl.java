 ...
 * </p>
 * <ul>
 *   <li>{@link info.scce.cinco.product.usersequence.usersequence.internal.impl.InternalButtonImpl#isHighlighted <em>Highlighted</em>}</li>
 *   <li>{@link info.scce.cinco.product.usersequence.usersequence.internal.impl.InternalButtonImpl#getAction <em>Action</em>}</li>
 *   <li>{@link info.scce.cinco.product.usersequence.usersequence.internal.impl.InternalButtonImpl#getSelector <em>Selector</em>}</li>
 *   <li>{@link info.scce.cinco.product.usersequence.usersequence.internal.impl.InternalButtonImpl#getValue <em>Value</em>}</li>
 *   <li>{@link info.scce.cinco.product.usersequence.usersequence.internal.impl.InternalButtonImpl#getContent <em>Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InternalButtonImpl extends InternalWebElementImpl implements InternalButton {
	/**
	 ...
	 * @ordered
	 */
	protected static final ButtonAction ACTION_EDEFAULT = ButtonAction.SUBMIT;
	...
	protected EClass eStaticClass() {
		return InternalPackage.eINSTANCE.getInternalButton();
	}
	...
	public void setHighlighted(boolean newHighlighted) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_BUTTON__HIGHLIGHTED, oldHighlighted, highlighted));
	}
	...
	public void setAction(ButtonAction newAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_BUTTON__ACTION, oldAction, action));
	}
	...
	public void setSelector(String newSelector) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_BUTTON__SELECTOR, oldSelector, selector));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_BUTTON__VALUE, oldValue, value));
	}
	...
	public void setContent(String newContent) {
		...
		content = newContent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_BUTTON__CONTENT, oldContent, content));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InternalPackage.INTERNAL_BUTTON__HIGHLIGHTED:
				return isHighlighted();
			case InternalPackage.INTERNAL_BUTTON__ACTION:
				return getAction();
			case InternalPackage.INTERNAL_BUTTON__SELECTOR:
				return getSelector();
			case InternalPackage.INTERNAL_BUTTON__VALUE:
				return getValue();
			case InternalPackage.INTERNAL_BUTTON__CONTENT:
				return getContent();
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == InternalNode.class) {
			switch (baseOperationID) {
				case graphmodel.internal.InternalPackage.INTERNAL_NODE___GET_OUTGOING_CONSTRAINTS: return InternalPackage.INTERNAL_BUTTON___GET_OUTGOING_CONSTRAINTS;
				case graphmodel.internal.InternalPackage.INTERNAL_NODE___GET_INCOMING_CONSTRAINTS: return InternalPackage.INTERNAL_BUTTON___GET_INCOMING_CONSTRAINTS;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == InternalWebElement.class) {
			switch (baseOperationID) {
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_INCOMING_CONSTRAINTS: return InternalPackage.INTERNAL_BUTTON___GET_INCOMING_CONSTRAINTS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_OUTGOING_CONSTRAINTS: return InternalPackage.INTERNAL_BUTTON___GET_OUTGOING_CONSTRAINTS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_START_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_START_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_SUB_SEQUENCE_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_SUB_SEQUENCE_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_SCREENSHOT_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_SCREENSHOT_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_SECTION_NODE_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_SECTION_NODE_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_NAVIGATION_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_NAVIGATION_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_WEB_ELEMENT_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_WEB_ELEMENT_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_DIV_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_DIV_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_HPREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_HPREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_PPREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_PPREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_SPAN_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_SPAN_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_LABEL_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_LABEL_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_FORM_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_FORM_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_INPUT_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_INPUT_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_TEXTAREA_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_TEXTAREA_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_BUTTON_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_BUTTON_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_SELECT_BOX_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_SELECT_BOX_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_SELECT_BOX_OPTION_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_SELECT_BOX_OPTION_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_TABLE_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_TABLE_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_TABLE_HEAD_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_TABLE_HEAD_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_TH_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_TH_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_TABLE_ROW_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_TABLE_ROW_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_TABLE_BODY_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_TABLE_BODY_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_TABLE_DATA_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_TABLE_DATA_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_SECTION_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_SECTION_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_COMMENT_PREDECESSORS: return InternalPackage.INTERNAL_BUTTON___GET_COMMENT_PREDECESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_STOP_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_STOP_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_SUB_SEQUENCE_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_SUB_SEQUENCE_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_SCREENSHOT_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_SCREENSHOT_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_SECTION_NODE_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_SECTION_NODE_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_NAVIGATION_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_NAVIGATION_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_WEB_ELEMENT_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_WEB_ELEMENT_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_DIV_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_DIV_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_HSUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_HSUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_PSUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_PSUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_SPAN_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_SPAN_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_LABEL_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_LABEL_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_FORM_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_FORM_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_INPUT_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_INPUT_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_TEXTAREA_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_TEXTAREA_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_BUTTON_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_BUTTON_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_SELECT_BOX_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_SELECT_BOX_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_SELECT_BOX_OPTION_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_SELECT_BOX_OPTION_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_TABLE_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_TABLE_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_TABLE_HEAD_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_TABLE_HEAD_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_TH_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_TH_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_TABLE_ROW_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_TABLE_ROW_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_TABLE_BODY_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_TABLE_BODY_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_TABLE_DATA_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_TABLE_DATA_SUCCESSORS;
				case InternalPackage.INTERNAL_WEB_ELEMENT___GET_SECTION_SUCCESSORS: return InternalPackage.INTERNAL_BUTTON___GET_SECTION_SUCCESSORS;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case InternalPackage.INTERNAL_BUTTON___GET_INCOMING_CONSTRAINTS:
				return getIncomingConstraints();
			case InternalPackage.INTERNAL_BUTTON___GET_OUTGOING_CONSTRAINTS:
				return getOutgoingConstraints();
			case InternalPackage.INTERNAL_BUTTON___GET_START_PREDECESSORS:
				return getStartPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_SUB_SEQUENCE_PREDECESSORS:
				return getSubSequencePredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_SCREENSHOT_PREDECESSORS:
				return getScreenshotPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_SECTION_NODE_PREDECESSORS:
				return getSectionNodePredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_NAVIGATION_PREDECESSORS:
				return getNavigationPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_WEB_ELEMENT_PREDECESSORS:
				return getWebElementPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_DIV_PREDECESSORS:
				return getDivPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_HPREDECESSORS:
				return getHPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_PPREDECESSORS:
				return getPPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_SPAN_PREDECESSORS:
				return getSpanPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_LABEL_PREDECESSORS:
				return getLabelPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_FORM_PREDECESSORS:
				return getFormPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_INPUT_PREDECESSORS:
				return getInputPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_TEXTAREA_PREDECESSORS:
				return getTextareaPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_BUTTON_PREDECESSORS:
				return getButtonPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_SELECT_BOX_PREDECESSORS:
				return getSelectBoxPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_SELECT_BOX_OPTION_PREDECESSORS:
				return getSelectBoxOptionPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_TABLE_PREDECESSORS:
				return getTablePredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_TABLE_HEAD_PREDECESSORS:
				return getTableHeadPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_TH_PREDECESSORS:
				return getThPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_TABLE_ROW_PREDECESSORS:
				return getTableRowPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_TABLE_BODY_PREDECESSORS:
				return getTableBodyPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_TABLE_DATA_PREDECESSORS:
				return getTableDataPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_SECTION_PREDECESSORS:
				return getSectionPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_COMMENT_PREDECESSORS:
				return getCommentPredecessors();
			case InternalPackage.INTERNAL_BUTTON___GET_STOP_SUCCESSORS:
				return getStopSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_SUB_SEQUENCE_SUCCESSORS:
				return getSubSequenceSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_SCREENSHOT_SUCCESSORS:
				return getScreenshotSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_SECTION_NODE_SUCCESSORS:
				return getSectionNodeSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_NAVIGATION_SUCCESSORS:
				return getNavigationSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_WEB_ELEMENT_SUCCESSORS:
				return getWebElementSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_DIV_SUCCESSORS:
				return getDivSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_HSUCCESSORS:
				return getHSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_PSUCCESSORS:
				return getPSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_SPAN_SUCCESSORS:
				return getSpanSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_LABEL_SUCCESSORS:
				return getLabelSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_FORM_SUCCESSORS:
				return getFormSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_INPUT_SUCCESSORS:
				return getInputSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_TEXTAREA_SUCCESSORS:
				return getTextareaSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_BUTTON_SUCCESSORS:
				return getButtonSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_SELECT_BOX_SUCCESSORS:
				return getSelectBoxSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_SELECT_BOX_OPTION_SUCCESSORS:
				return getSelectBoxOptionSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_TABLE_SUCCESSORS:
				return getTableSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_TABLE_HEAD_SUCCESSORS:
				return getTableHeadSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_TH_SUCCESSORS:
				return getThSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_TABLE_ROW_SUCCESSORS:
				return getTableRowSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_TABLE_BODY_SUCCESSORS:
				return getTableBodySuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_TABLE_DATA_SUCCESSORS:
				return getTableDataSuccessors();
			case InternalPackage.INTERNAL_BUTTON___GET_SECTION_SUCCESSORS:
