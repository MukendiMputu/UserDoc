 ...
 * </p>
 * <ul>
 *   <li>{@link info.scce.cinco.product.usersequence.usersequence.internal.impl.InternalScreenshotImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InternalScreenshotImpl extends InternalNodeImpl implements InternalScreenshot {
	/**
	 ...
	 * @generated
	 */
	protected InternalScreenshotImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return InternalPackage.eINSTANCE.getInternalScreenshot();
	}
	...
	public Comment getDescription() {
		if (description != null && description.eIsProxy()) {
			...
			description = (Comment)eResolveProxy(oldDescription);
			if (description != oldDescription) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InternalPackage.INTERNAL_SCREENSHOT__DESCRIPTION, oldDescription, description));
			}
		}
		return description;
	}
	 ...
	 * @generated
	 */
	public Comment basicGetDescription() {
		return description;
	}
	...
	public void setDescription(Comment newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_SCREENSHOT__DESCRIPTION, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InternalPackage.INTERNAL_SCREENSHOT__DESCRIPTION:
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == InternalNode.class) {
			switch (baseOperationID) {
				case graphmodel.internal.InternalPackage.INTERNAL_NODE___GET_OUTGOING_CONSTRAINTS: return InternalPackage.INTERNAL_SCREENSHOT___GET_OUTGOING_CONSTRAINTS;
				case graphmodel.internal.InternalPackage.INTERNAL_NODE___GET_INCOMING_CONSTRAINTS: return InternalPackage.INTERNAL_SCREENSHOT___GET_INCOMING_CONSTRAINTS;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case InternalPackage.INTERNAL_SCREENSHOT___GET_INCOMING_CONSTRAINTS:
				return getIncomingConstraints();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_OUTGOING_CONSTRAINTS:
				return getOutgoingConstraints();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_START_PREDECESSORS:
				return getStartPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_SUB_SEQUENCE_PREDECESSORS:
				return getSubSequencePredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_INPUT_PREDECESSORS:
				return getInputPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_TEXTAREA_PREDECESSORS:
				return getTextareaPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_BUTTON_PREDECESSORS:
				return getButtonPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_SELECT_BOX_PREDECESSORS:
				return getSelectBoxPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_SELECT_BOX_OPTION_PREDECESSORS:
				return getSelectBoxOptionPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_TABLE_PREDECESSORS:
				return getTablePredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_TABLE_HEAD_PREDECESSORS:
				return getTableHeadPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_TH_PREDECESSORS:
				return getThPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_TABLE_ROW_PREDECESSORS:
				return getTableRowPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_TABLE_BODY_PREDECESSORS:
				return getTableBodyPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_TABLE_DATA_PREDECESSORS:
				return getTableDataPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_SECTION_PREDECESSORS:
				return getSectionPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_SCREENSHOT_PREDECESSORS:
				return getScreenshotPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_SECTION_NODE_PREDECESSORS:
				return getSectionNodePredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_NAVIGATION_PREDECESSORS:
				return getNavigationPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_WEB_ELEMENT_PREDECESSORS:
				return getWebElementPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_DIV_PREDECESSORS:
				return getDivPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_HPREDECESSORS:
				return getHPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_PPREDECESSORS:
				return getPPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_SPAN_PREDECESSORS:
				return getSpanPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_LABEL_PREDECESSORS:
				return getLabelPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_FORM_PREDECESSORS:
				return getFormPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_COMMENT_PREDECESSORS:
				return getCommentPredecessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_STOP_SUCCESSORS:
				return getStopSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_SUB_SEQUENCE_SUCCESSORS:
				return getSubSequenceSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_SCREENSHOT_SUCCESSORS:
				return getScreenshotSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_SECTION_NODE_SUCCESSORS:
				return getSectionNodeSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_NAVIGATION_SUCCESSORS:
				return getNavigationSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_WEB_ELEMENT_SUCCESSORS:
				return getWebElementSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_DIV_SUCCESSORS:
				return getDivSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_HSUCCESSORS:
				return getHSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_PSUCCESSORS:
				return getPSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_SPAN_SUCCESSORS:
				return getSpanSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_LABEL_SUCCESSORS:
				return getLabelSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_FORM_SUCCESSORS:
				return getFormSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_INPUT_SUCCESSORS:
				return getInputSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_TEXTAREA_SUCCESSORS:
				return getTextareaSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_BUTTON_SUCCESSORS:
				return getButtonSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_SELECT_BOX_SUCCESSORS:
				return getSelectBoxSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_SELECT_BOX_OPTION_SUCCESSORS:
				return getSelectBoxOptionSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_TABLE_SUCCESSORS:
				return getTableSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_TABLE_HEAD_SUCCESSORS:
				return getTableHeadSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_TH_SUCCESSORS:
				return getThSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_TABLE_ROW_SUCCESSORS:
				return getTableRowSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_TABLE_BODY_SUCCESSORS:
				return getTableBodySuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_TABLE_DATA_SUCCESSORS:
				return getTableDataSuccessors();
			case InternalPackage.INTERNAL_SCREENSHOT___GET_SECTION_SUCCESSORS:
				return getSectionSuccessors();
		}
		return super.eInvoke(operationID, arguments);
	}

} //InternalScreenshotImpl
