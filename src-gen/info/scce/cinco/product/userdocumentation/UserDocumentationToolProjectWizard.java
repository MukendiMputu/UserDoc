...
public class UserDocumentationToolProjectWizard extends Wizard implements IWorkbenchWizard {
	...
	public boolean performFinish() {
		...
		try {
			workbench.showPerspective("info.scce.cinco.product.userdocumentation.userdocumentationtoolperspective", workbench.getActiveWorkbenchWindow());
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		setWindowTitle("New UserDocumentationTool Project");
	}
	...
	private class CreateNewProjectPage extends WizardPage {
		...
		protected CreateNewProjectPage(String pageName) {
			super(pageName);
			setTitle("New UserDocumentationTool Project");
			setDescription("Initialize an empty UserDocumentationTool project and switch to correct perspective");
